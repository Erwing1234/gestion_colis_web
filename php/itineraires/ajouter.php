...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_sql = "SELECT codeit FROM itineraire WHERE codeit = '$codeit'";
    $result = $conn->query($check_sql);
    
    if ($result->num_rows > 0) {
        $error = "Ce code d'itinéraire existe déjà.";
    } else {
        // Insérer l'itinéraire
        $sql = "INSERT INTO itineraire (codeit, villedep, villearr, frais) VALUES ('$codeit', '$villedep', '$villearr', $frais)";
        
        if ($conn->query($sql) === TRUE) {
            $success = "Itinéraire ajouté avec succès.";
        } else {
...
<head>
    ...
    <title>Ajouter un Itinéraire - Gestion des colis</title>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="form-container">
                    <h2 class="mb-4"><i class="fas fa-route me-2"></i>Ajouter un itinéraire</h2>
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="needs-validation" novalidate>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="codeit" name="codeit" required>
                            <div class="invalid-feedback">
                                Veuillez saisir un code d'itinéraire.
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="villearr" name="villearr" required>
                            <div class="invalid-feedback">
